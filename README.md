...
Ensure that you have the following up and running:
 ...
 👉  Ensure you system has a  Pytorch environment (https://nrp.ai/)

 👉  Log in with your CSUSB assigned namespaced (https://nrp.ai/)

 👉 Kinkly use the collaborative workspace for team coordination and project communication
